...
/*   Updated: 2025/08/08 08:13:25 by hfalati          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->ray.dir.x == 0)
		game->ray.delta_dist.x = 1000000000000000000000000000000.0;
	else
		game->ray.delta_dist.x = fabs(1 / game->ray.dir.x);
	if (game->ray.dir.y == 0)
		game->ray.delta_dist.y = 1000000000000000000000000000000.0;
	else
